...
{
    public partial class microbialNonInhalableReport : Form
    {
        public microbialNonInhalableReport()
        {
            InitializeComponent();
        }

        private void microbialNonInhalableReport_Load(object sender, EventArgs e)
        {
