...
{
    public partial class potencyViewerNonInhalable : Form
    {
        public potencyViewerNonInhalable()
        {
            InitializeComponent();
        }

        private void potencyViewerNonInhalable_Load(object sender, EventArgs e)
        {
