...
{
    public partial class solventViewerNonInhalable : Form
    {
        public solventViewerNonInhalable()
        {
            InitializeComponent();
        }

        private void solventViewerNonInhalable_Load(object sender, EventArgs e)
        {
